...
export let options = {
    stages: [
        { duration: '120s', target: 20 },  // ramp up to 20 users over 120 seconds
        { duration: '240s', target: 20 }, // maintain 20 users for 240 seconds
        { duration: '120s', target: 0 },   // ramp down to 0 users over 120 seconds
    ],
//    vus: 1,
//    duration: '300s',
};
